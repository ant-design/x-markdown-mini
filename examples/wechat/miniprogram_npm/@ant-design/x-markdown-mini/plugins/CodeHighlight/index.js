...
// src/plugins/CodeHighlight/index.ts
var CodeHighlight_exports = {};
__export(CodeHighlight_exports, {
...
function CodeHighlight(options = {}) {
  ...
  const ignoreIllegals = (_a = hljsOptions == null ? void 0 : hljsOptions.ignoreIllegals) != null ? _a : true;
  if (languages) {
    ...
    extensions: [
      {
        ...
        miniRenderer: (token, _ctx) => {
          var _a2, _b;
          const t = token;
          const lang = (_a2 = t.lang) == null ? void 0 : _a2.trim();
          const text = (_b = t.text) != null ? _b : "";
          if (!lang) return null;
          const resolved = ALIASES[lang] || lang;
          if (!core_default.getLanguage(resolved)) return null;
          try {
            const result = core_default.highlight(text, {
              language: resolved,
              ignoreIllegals
            });
